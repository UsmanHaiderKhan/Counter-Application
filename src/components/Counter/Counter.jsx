...
const Counter = memo(function Counter({ initialCount }) {
  ...
  // this method reloading the the whole component every time the initialCount changes. instead we should use key prop in the parent component to force re-rendering
  // useEffect(() => {
